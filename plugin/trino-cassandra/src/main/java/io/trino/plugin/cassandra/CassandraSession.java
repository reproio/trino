        ...
        implements Closeable
{
    ...
    public CassandraSession(JsonCodec<List<ExtraColumnMetadata>> extraColumnMetadataCodec, Supplier<CqlSession> sessionSupplier, Duration noHostAvailableRetryTimeout, boolean skipPartitionCheck)
    {
