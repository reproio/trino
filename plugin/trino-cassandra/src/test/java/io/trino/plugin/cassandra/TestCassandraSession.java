...
public class TestCassandraSession
{
    ...
    private CassandraSession buildNativeSession(boolean skipPartitionCheck)
    {
        ...
        CqlSessionBuilder cqlSessionBuilder = CqlSession.builder()
                ...
                .addContactPoint(new InetSocketAddress(server.getHost(), server.getPort()))
    ...
    private CassandraTable createSinglePartitionKeyTable(String tableName)
    {
        ...
        CassandraColumnHandle col1 = new CassandraColumnHandle("partition_key1", 1, CassandraTypes.BIGINT, true, false, false, false);
        CassandraColumnHandle col2 = new CassandraColumnHandle("clustering_key1", 2, CassandraTypes.BIGINT, false, true, false, false);
        return new CassandraTable(new CassandraNamedRelationHandle(KEYSPACE, tableName), ImmutableList.of(col1, col2));
    }
    ...
    private CassandraTable createMultiplePartitionKeyTable(String tableName)
    {
        ...
        CassandraColumnHandle col1 = new CassandraColumnHandle("partition_key1", 1, CassandraTypes.BIGINT, true, false, false, false);
        CassandraColumnHandle col2 = new CassandraColumnHandle("partition_key2", 2, CassandraTypes.TEXT, true, false, false, false);
        CassandraColumnHandle col3 = new CassandraColumnHandle("clustering_key1", 3, CassandraTypes.BIGINT, false, true, false, false);
        return new CassandraTable(new CassandraNamedRelationHandle(KEYSPACE, tableName), ImmutableList.of(col1, col2, col3));
    }
}
